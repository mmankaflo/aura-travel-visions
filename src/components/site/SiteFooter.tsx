      ...
      <div className="container-x py-16 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <div className="mt-5 flex gap-3">
            <a href="https://www.instagram.com/aura_travelandtours?igsh=dG9zdzFrNzRrbG0z" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="grid h-9 w-9 place-items-center rounded-full border border-white/15 hover:border-[var(--gold)] hover:text-[var(--gold)]"><Instagram className="h-4 w-4" /></a>
            <a href="https://www.facebook.com/share/1RYT1tVzTM/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="grid h-9 w-9 place-items-center rounded-full border border-white/15 hover:border-[var(--gold)] hover:text-[var(--gold)]"><Facebook className="h-4 w-4" /></a>
            <a href="https://twitter.com/AuraTravelandT" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="grid h-9 w-9 place-items-center rounded-full border border-white/15 hover:border-[var(--gold)] hover:text-[var(--gold)]"><Twitter className="h-4 w-4" /></a>
            <a href="https://LinkedIn.com/company/aura-travel-and-tours" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="grid h-9 w-9 place-items-center rounded-full border border-white/15 hover:border-[var(--gold)] hover:text-[var(--gold)]"><Linkedin className="h-4 w-4" /></a>
            <a href="https://www.tiktok.com/@auratravelandtour?_r=1&_t=ZS-97I1VDHUiVW" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="grid h-9 w-9 place-items-center rounded-full border border-white/15 hover:border-[var(--gold)] hover:text-[var(--gold)]">
