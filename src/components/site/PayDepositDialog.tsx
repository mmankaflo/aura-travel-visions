      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="font-display text-2xl">
            Secure your {packageName} trip
          </DialogTitle>
          <DialogDescription>
            Pay a R{amount.toLocaleString("en-ZA")} deposit to lock in your booking. Balance (
            {totalLabel}) is settled before travel.
          </DialogDescription>
        </DialogHeader>
        <form
          onSubmit={(e) => {
        ...
        >
          <div className="grid gap-2">
            ...
            <Input id="pd-name" name="name" required />
          </div>
          <div className="grid gap-2">
          ...
          <div className="rounded-xl border border-border bg-secondary/50 p-4 text-sm flex items-start gap-3">
            ...
            <p className="text-muted-foreground">
              You'll be redirected to <span className="font-semibold text-foreground">PayFast</span>
              , South Africa's trusted payment gateway, to complete payment securely.
            </p>
          </div>
          <button
            type="submit"
