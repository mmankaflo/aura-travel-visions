  ...
  head: () => ({
    meta: [
      ...
      { title: "Aura Travel & Tours | Luxury Travel Agency South Africa" },
      {
        name: "description",
        content:
          "Premium South African travel agency offering Dubai, Mauritius, Zanzibar, Cape Town packages, safaris, corporate travel, visa assistance and religious tours.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/16834025-7671-49d1-b0bf-68dfc6658431/id-preview-3cf130dd--f9afbfde-9b5f-45f8-b3f8-d8b0a0e887d2.lovable.app-1781797588168.png",
      },
      {
        name: "twitter:image",
        content:
