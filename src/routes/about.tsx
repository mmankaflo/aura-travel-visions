...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Aura Travel & Tours is a Johannesburg-based travel agency helping South Africans explore local and international destinations with confidence." },
      { property: "og:title", content: "About Aura Travel & Tours" },
      { property: "og:description", content: "A trusted South African travel partner since day one." },
...
function About() {
  return (
    <>
      <PageHero title="Crafting journeys, building memories." subtitle="A Johannesburg travel house dedicated to seamless, soulful travel." image={heroDubai} />
      <section className="py-24">
        <div className="container-x grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="relative">
            <img src={destCapetown} alt="Cape Town" loading="lazy" className="rounded-3xl shadow-luxe aspect-[4/5] object-cover" />
