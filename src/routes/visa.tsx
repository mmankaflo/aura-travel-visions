  ...
  head: () => ({
    meta: [
      { title: "Professional Visa Assistance Services | Aura Travel & Tours" },
      {
        name: "description",
        content:
          "Professional visa assistance from South Africa. Tourist, business, student and family visit visas with document review, insurance and appointment booking guidance.",
      },
      { property: "og:title", content: "Visa Assistance, Aura Travel & Tours" },
      {
        property: "og:description",
        content:
          "We simplify the visa application process by helping you prepare the required documentation and guiding you every step of the way.",
      },
...
const services = [
  {
    icon: Globe2,
    emoji: "🌍",
    t: "Tourist Visa Assistance",
    d: "Holiday and leisure visas for popular destinations worldwide.",
  },
  {
    icon: Briefcase,
    emoji: "💼",
    t: "Business Visa Assistance",
    d: "Meetings, conferences and corporate travel visa support.",
  },
  {
    icon: GraduationCap,
    emoji: "🎓",
    t: "Student Visa Assistance",
    d: "Study abroad applications, acceptance letters and financial proofs.",
  },
  {
    icon: Users,
    emoji: "👨‍👩‍👧",
    t: "Family Visit Visa Assistance",
    d: "Visiting loved ones overseas with sponsorship and invitation guidance.",
  },
  {
    icon: FileCheck2,
    emoji: "📄",
    t: "Document Review & Verification",
    d: "Pre-submission checks to catch errors and missing documents.",
  },
  {
    icon: ShieldPlus,
    emoji: "🛡",
    t: "Travel Insurance Assistance",
    d: "Comprehensive cover that meets embassy requirements.",
  },
  {
    icon: CalendarCheck,
    emoji: "📅",
    t: "Visa Appointment Booking Guidance",
    d: "Slot booking guidance at VFS, embassies and consulates.",
  },
];
...
const steps = [
  {
    ...
    d: "Tell us your destination, purpose of travel and dates.",
  },
  {
    n: "02",
    icon: ListChecks,
    t: "Personalised checklist",
    d: "Receive a tailored document checklist for your visa type.",
  },
  {
    n: "03",
    icon: FolderUp,
    t: "Share your documents",
    d: "Upload or drop off your supporting documents securely.",
  },
  {
    n: "04",
    icon: Search,
    t: "Expert review",
    d: "Our team reviews your full application package for accuracy.",
  },
  {
    n: "05",
    icon: PlaneTakeoff,
    t: "Appointment & tracking",
    d: "Attend your visa appointment and we help you track progress.",
  },
];
        ...
        <div className="container-x">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="mt-3 font-display text-4xl md:text-5xl font-semibold">
              Visa support for every traveller
            </h2>
            <p className="mt-4 text-muted-foreground">
              From tourist visas to student applications, our specialists handle every type of
          ...
          <div className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {services.map(({ icon: Icon, emoji, t, d }) => (
              <div
                key={t}
                className="group rounded-2xl border border-border bg-card p-7 hover:border-[var(--gold)]/50 hover:shadow-card transition-all"
              >
        ...
        <div className="container-x">
          ...
          <div className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
            {steps.map(({ n, icon: Icon, t, d }) => (
              <div
                key={n}
                className="relative rounded-2xl border border-white/10 bg-white/[0.04] p-6 hover:bg-white/[0.08] transition-all"
              >
                <span className="absolute -top-3 left-6 rounded-full bg-[var(--gold)] px-3 py-0.5 text-xs font-bold text-[var(--navy-deep)]">
                  Step {n}
                </span>
        ...
        <div className="container-x">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            ...
            <p className="max-w-md text-muted-foreground">
              Typical processing times shown are indicative. Final timelines are set by the issuing
        ...
        <div className="container-x grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              We treat every application like our own, with the diligence and care your travel plans
              deserve.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-[var(--gold)]/40 bg-white/[0.04] p-8 md:p-10 text-white flex flex-col md:flex-row gap-6 items-start">
            ...
            <div>
              ...
              <p className="mt-3 text-white/85 leading-relaxed">
                We assist clients with visa applications, documentation preparation, and appointment
                guidance. Visa approvals remain at the sole discretion of the relevant embassy,
                consulate, or immigration authority. Aura Travel &amp; Tours does not guarantee visa
                approval.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container-x text-center">
          ...
          <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
            Speak to a visa specialist today. We respond within 24 hours.
          </p>
          <VisaEnquiryDialog
            trigger={
