  ...
  head: () => ({
    meta: [
      { title: "Religious Tours & Holy Land Spiritual Journeys | Aura Travel & Tours" },
      {
        name: "description",
        content:
          "Christian Holy Land tours and group spiritual journey packages from South Africa with experienced faith-travel coordinators.",
      },
...
const tours = [
  {
    icon: Church,
    t: "Christian Tours",
    d: "Journeys to Rome, the Vatican and significant Christian sites across Europe.",
  },
  {
    icon: MapPin,
    t: "Holy Land Tours",
    d: "Walk where it all began, Jerusalem, Bethlehem, Galilee and Nazareth.",
  },
  {
    icon: Users,
    t: "Group Spiritual Journeys",
    d: "Custom packages for church groups, congregations and ministries.",
  },
];
...
function Religious() {
  return (
    <>
      <PageHero
        title="Spiritual journeys with purpose."
        subtitle="Faith-led travel curated with care for individuals and church groups."
        image={religious}
      />
        ...
        <div className="container-x">
          <div className="grid md:grid-cols-3 gap-6">
            {tours.map(({ icon: Icon, t, d }) => (
              <div
                key={t}
                className="rounded-2xl border border-border p-8 text-center hover:shadow-card hover:border-[var(--gold)]/40 transition-all"
              >
                <div className="mx-auto grid h-14 w-14 place-items-center rounded-full bg-[var(--navy-deep)] text-[var(--gold)]">
          ...
          <div className="mt-16 grid lg:grid-cols-2 gap-10 items-center rounded-3xl overflow-hidden bg-secondary">
            ...
            <div className="p-8 lg:p-12">
              ...
              <ul className="mt-6 space-y-3 text-sm">
                {[
                  "Spiritual guide & local pastor liaison",
                  "Group flights & airport transfers",
                  "4★ hotel accommodation",
                  "Daily devotional itinerary",
