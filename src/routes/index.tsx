  ...
  head: () => ({
    meta: [
      { title: "Aura Travel & Tours | Luxury Holiday Packages South Africa" },
      {
        name: "description",
        content:
          "Affordable luxury holiday packages from South Africa, Dubai, Mauritius, Zanzibar, Cape Town safaris, corporate travel, visa assistance and religious tours.",
      },
      { property: "og:title", content: "Aura Travel & Tours, Explore the World with Confidence" },
      {
        property: "og:description",
        content: "Tailored local & international travel packages from Johannesburg.",
      },
...
const destinations = [
  {
    name: "Dubai",
    img: destDubai,
    blurb: "Burj Khalifa, luxury hotels & desert safaris.",
    tag: "From R9,999",
  },
  {
    name: "Mauritius",
    img: destMauritius,
    blurb: "Overwater villas, white sand & honeymoons.",
    tag: "From R12,999",
  },
  {
    name: "Zanzibar",
    img: destZanzibar,
    blurb: "Tropical beaches & Stone Town culture.",
    tag: "From R10,999",
  },
  {
    name: "Cape Town",
    img: destCapetown,
    blurb: "Table Mountain, V&A Waterfront & wine.",
    tag: "From R4,999",
  },
  {
    name: "SA Safari",
    img: destSafari,
    blurb: "Kruger, Garden Route & Big Five.",
    tag: "From R6,999",
  },
  {
    name: "United Kingdom",
    img: destUk,
    blurb: "London icons, royal heritage & countryside charm.",
    tag: "From R24,999",
  },
  {
    name: "Canada",
    img: destCanada,
    blurb: "Rocky Mountains, Banff lakes & Niagara Falls.",
    tag: "From R28,999",
  },
  {
    name: "United States",
    img: destUsa,
    blurb: "New York, Vegas, theme parks & national parks.",
    tag: "From R26,999",
  },
  {
    name: "Australia",
    img: destAustralia,
    blurb: "Sydney Harbour, Great Barrier Reef & outback.",
    tag: "From R32,999",
  },
  {
    name: "Mozambique",
    img: destMozambique,
    blurb: "Bazaruto sand dunes, dhow sails & turquoise reefs.",
    tag: "From R8,999",
  },
];
...
const services = [
  {
    ...
    desc: "Best fares with trusted airlines and 4–5★ stays.",
  },
  ...
  Dubai: [
    {
      ...
      desc: "Sunset views from the world's tallest building, level 124 & 125.",
      image: actDubaiBurj,
    },
    {
      title: "Desert Safari & Dune Bashing",
      desc: "4x4 dune adventure, camel rides and a Bedouin BBQ under the stars.",
      image: actDubaiDesert,
    },
    {
      title: "Dubai Marina Yacht Cruise",
      desc: "Glide past the Palm & Atlantis on a private luxury catamaran.",
      image: actDubaiMarina,
    },
    {
      title: "Gold & Spice Souks",
      desc: "Old Dubai abra ride and guided tour of the historic souks.",
      image: actDubaiSouk,
    },
  ],
  Mauritius: [
    {
      ...
      desc: "Full-day island hop with snorkeling, BBQ lunch and waterfall stop.",
      image: actMuIle,
    },
    {
      title: "Black River Gorges",
      desc: "Hike rainforests, viewpoints and the seven coloured earths of Chamarel.",
      image: actMuBlackRiver,
    },
    {
      title: "Dolphin Swim at Tamarin",
      desc: "Early-morning boat trip to swim with wild spinner dolphins.",
      image: actMuDolphins,
    },
    {
      title: "Le Morne Beach Day",
      desc: "UNESCO-listed peninsula, kite surfing, snorkeling & sunset cocktails.",
      image: actMuLeMorne,
    },
  ],
  Zanzibar: [
    {
      ...
      desc: "Spice market, House of Wonders and Freddie Mercury's birthplace.",
      image: actZnStone,
    },
    {
      title: "Nakupenda Sandbank",
      desc: "Boat trip to a pristine sandbar with fresh seafood lunch.",
      image: actZnNakupenda,
    },
    {
      title: "Spice Farm Tour",
      desc: "Taste cloves, vanilla and nutmeg straight from the source.",
      image: actZnSpice,
    },
    {
      title: "Mnemba Atoll Snorkel",
      desc: "Reef teeming with turtles, dolphins and tropical fish.",
      image: actZnMnemba,
    },
  ],
  "Cape Town": [
    {
      ...
      desc: "Rotating cable car to the iconic flat-topped summit.",
      image: actCtTable,
    },
    {
      title: "Cape Point & Boulders Beach",
      desc: "Peninsula drive with African penguins at Boulders.",
      image: actCtCapePoint,
    },
    {
      title: "Stellenbosch Winelands",
      desc: "Tastings at boutique estates with Cape Dutch architecture.",
      image: actCtStellen,
    },
    {
      title: "V&A Waterfront",
      desc: "Harbour dining, Two Oceans Aquarium and Robben Island ferry.",
      image: actCtVa,
    },
  ],
  "SA Safari": [
    {
      ...
      desc: "Dawn & dusk drives with expert rangers in private Kruger concessions.",
      image: actSfBigFive,
    },
    {
      title: "Bush Walk Experience",
      desc: "Tracked walk with armed guide, focus on tracks, plants and birding.",
      image: actSfBushwalk,
    },
    {
      title: "Boma Dinner Under the Stars",
      desc: "Open-fire feast with traditional music in the heart of the bush.",
      image: actSfBoma,
    },
    {
      title: "Panorama Route",
      desc: "Blyde River Canyon, God's Window and Bourke's Luck Potholes.",
      image: actSfPanorama,
    },
  ],
  "United Kingdom": [
    {
      title: "London Icons Tour",
      desc: "Big Ben, Westminster, Buckingham Palace and a Thames river cruise.",
      image: actUkLondon,
    },
    {
      title: "Tower of London & Crown Jewels",
      desc: "Guided tour through 1,000 years of royal history.",
      image: actUkTower,
    },
    {
      title: "Cotswolds Countryside Day",
      desc: "Honey-stone villages, pubs and English afternoon tea.",
      image: actUkCots,
    },
    {
      title: "Edinburgh Add-on",
      desc: "Castle, Royal Mile and Highlands optional extension.",
      image: actUkEdin,
    },
  ],
  Canada: [
    {
      ...
      desc: "Turquoise glacial lakes, gondolas and Rocky Mountain hikes.",
      image: actCaBanff,
    },
    {
      title: "Niagara Falls Experience",
      desc: "Hornblower boat cruise into the mist of the falls.",
      image: actCaNiagara,
    },
    {
      title: "Vancouver City & Capilano",
      desc: "Stanley Park, Granville Island and the suspension bridge.",
      image: actCaVan,
    },
    {
      title: "Whale Watching Victoria",
      desc: "Orcas, humpbacks and bald eagles off Vancouver Island.",
      image: actCaWhales,
    },
  ],
  "United States": [
    {
      ...
      desc: "Statue of Liberty, Empire State, Times Square and Broadway.",
      image: actUsNyc,
    },
    {
      title: "Las Vegas & Grand Canyon",
      desc: "Strip nightlife plus a helicopter tour over the canyon.",
      image: actUsVegas,
    },
    {
      title: "Orlando Theme Parks",
      desc: "Walt Disney World and Universal Studios family days.",
      image: actUsOrlando,
    },
    {
      title: "California Coast Drive",
      desc: "LA to San Francisco along the Pacific Coast Highway.",
      image: actUsCali,
    },
  ],
  Australia: [
    {
      ...
      desc: "Opera House, Harbour Bridge climb and Bondi Beach.",
      image: actAuSydney,
    },
    {
      title: "Great Barrier Reef",
      desc: "Snorkel or dive the world's largest coral reef from Cairns.",
      image: actAuReef,
    },
    {
      title: "Uluru Sunset Experience",
      desc: "Sacred red monolith with Sounds of Silence dinner.",
      image: actAuUluru,
    },
    {
      title: "Melbourne & Great Ocean Road",
      desc: "Coffee culture, laneways and the Twelve Apostles drive.",
      image: actAuMelb,
    },
  ],
  Mozambique: [
    {
      ...
      desc: "Aerial dune flights, sandbank picnics and snorkelling at Two Mile Reef.",
      image: actMzBazaruto,
    },
    {
      title: "Tofo Beach Days",
      desc: "Golden sand, ocean safaris and laid-back beach bars.",
      image: actMzTofo,
    },
    {
      title: "Whale Shark & Reef Diving",
      desc: "Dive with whale sharks, manta rays and turtles off Praia do Tofo.",
      image: actMzDiving,
    },
    {
      title: "Ilha de Mozambique",
      desc: "UNESCO Stone Town heritage walk, fortresses and Swahili-Portuguese culture.",
      image: actMzIlha,
    },
  ],
};
...
const packages = [
  {
    ...
    price: "R9,999",
    img: destDubai,
    includes: ["Return flights", "4 nights 4★ hotel", "Desert safari", "Burj Khalifa visit"],
  },
  {
    name: "Mauritius",
    price: "R12,999",
    img: destMauritius,
    includes: ["Return flights", "5 nights all-inclusive", "Island tour", "Airport transfers"],
  },
  {
    name: "Zanzibar",
    price: "R10,999",
    img: destZanzibar,
    includes: ["Return flights", "5 nights beach resort", "Spice tour", "Snorkeling trip"],
  },
  {
    name: "Cape Town",
    price: "R4,999",
    img: destCapetown,
    includes: ["Domestic flights", "3 nights hotel", "Table Mountain", "Winelands tour"],
  },
  {
    name: "SA Safari",
    price: "R6,999",
    img: destSafari,
    includes: ["Lodge stay 3 nights", "Game drives", "All meals", "Park fees"],
  },
  {
    name: "United Kingdom",
    price: "R24,999",
    img: destUk,
    includes: ["Return flights", "6 nights London 4★", "Hop-on city tour", "Tower of London entry"],
  },
  {
    name: "Canada",
    price: "R28,999",
  ...
  },
  {
    ...
    img: destMozambique,
    includes: [
      "Return flights to Vilanculos",
      "5 nights beach lodge",
      "Bazaruto dhow safari",
      "Snorkelling & transfers",
    ],
  },
];
    ...
    <>
      ...
      <section className="relative h-[100svh] min-h-[640px] w-full overflow-hidden">
        ...
        <div className="relative z-10 container-x h-full flex flex-col justify-center pt-20 text-white">
          <span className="text-xs sm:text-sm uppercase tracking-[0.35em] text-[var(--gold)] animate-float-up">
            Luxury Travel · Johannesburg
          </span>
          ...
          <p className="mt-6 max-w-2xl text-base sm:text-lg text-white/85 animate-float-up">
            {SITE.tagline}. Affordable local and international travel packages, expertly tailored to
            your story.
          </p>
          <div className="mt-8 flex flex-wrap gap-3 animate-float-up">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/10 backdrop-blur px-7 py-3.5 text-sm font-semibold text-white hover:bg-white/20"
            >
          ...
          <div className="mt-12 flex flex-wrap gap-x-8 gap-y-3 text-xs sm:text-sm text-white/70 animate-float-up">
            <span className="flex items-center gap-2">
              <Star className="h-4 w-4 text-[var(--gold)] fill-[var(--gold)]" /> 4.9 · 1,200+
              travellers
            </span>
            <span className="flex items-center gap-2">
              <ShieldCheck className="h-4 w-4 text-[var(--gold)]" /> Secure & ASATA-aligned
            </span>
            <span className="flex items-center gap-2">
              <Headphones className="h-4 w-4 text-[var(--gold)]" /> 24/7 support
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="container-x">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            <div>
              ...
              <h2 className="mt-3 font-display text-4xl md:text-5xl font-semibold">
                Where will Aura take you?
              </h2>
            </div>
            <p className="max-w-md text-muted-foreground">
              Hand-picked escapes loved by South African travellers, from beach hideaways to iconic
              city breaks.
            </p>
          </div>
          <div className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {destinations.map((d, i) => (
              <article
                key={d.name}
                className={`group relative overflow-hidden rounded-2xl shadow-card ${i === 0 ? "lg:row-span-2 lg:col-span-1 lg:h-auto" : ""}`}
              ...
              >
                ...
                <div className="absolute top-4 left-4 rounded-full bg-[var(--gold)] px-3 py-1 text-xs font-semibold text-[var(--navy-deep)]">
                  {d.tag}
                </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            <div>
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                Secure your spot with a 10% deposit via PayFast, South Africa's trusted payment
                gateway.
              </p>
            </div>
            <Link
              to="/contact"
              className="text-sm font-semibold text-[var(--navy-deep)] underline underline-offset-4"
            >
          ...
          <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {packages.map((p) => {
              ...
              return (
                <article
                  key={p.name}
                  className="overflow-hidden rounded-2xl bg-card shadow-card flex flex-col"
                >
                  <div className="relative aspect-[5/3] overflow-hidden">
                    <img
                      src={p.img}
                      alt={`${p.name} travel package`}
                      loading="lazy"
                      className="h-full w-full object-cover transition-transform duration-700 hover:scale-110"
                    />
                    <div className="absolute top-4 right-4 rounded-full bg-[var(--navy-deep)]/85 backdrop-blur px-3 py-1 text-xs font-semibold text-white">
                      Starting {p.price}
                    </div>
                  </div>
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Per person sharing, handcrafted by our specialists.
                    </p>
      ...
      <section className="py-24 bg-[var(--navy-deep)] text-white">
        <div className="container-x">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="mt-3 font-display text-4xl md:text-5xl font-semibold">
              Everything for the modern traveller
            </h2>
            <p className="mt-4 text-white/70">
              From leisure to corporate, spiritual journey to safari, one trusted partner.
            </p>
          </div>
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {services.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="group rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:bg-white/[0.06] hover:border-[var(--gold)]/40 transition-all"
              >
      ...
      <section className="py-24 bg-background">
        <div className="container-x grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <h2 className="mt-3 font-display text-4xl md:text-5xl font-semibold">
              A travel partner you can <span className="text-gradient-gold">trust</span>.
            </h2>
            <p className="mt-5 text-muted-foreground max-w-lg">
              From your first enquiry to your safe return home, our specialists obsess over the
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {whyUs.map(({ icon: Icon, t, d }) => (
              <div
                key={t}
                className="rounded-2xl border border-border bg-card p-6 hover:border-[var(--gold)]/40 hover:shadow-card transition-all"
              >
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative container-x text-center text-white">
          <h2 className="font-display text-4xl md:text-6xl font-semibold max-w-3xl mx-auto">
            Your next great escape starts here.
          </h2>
          <p className="mt-5 max-w-xl mx-auto text-white/80">
            Speak to a real travel specialist today, no bots, no pressure.
          </p>
