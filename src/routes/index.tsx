...
const packageActivities: Record<string, ExploreActivity[]> = {
  Dubai: [
    { title: "Burj Khalifa Sky Deck", desc: "Sunset views from the world's tallest building, level 124 & 125.", image: actDubaiBurj },
    { title: "Desert Safari & Dune Bashing", desc: "4x4 dune adventure, camel rides and a Bedouin BBQ under the stars.", image: actDubaiDesert },
    { title: "Dubai Marina Yacht Cruise", desc: "Glide past the Palm & Atlantis on a private luxury catamaran.", image: actDubaiMarina },
    { title: "Gold & Spice Souks", desc: "Old Dubai abra ride and guided tour of the historic souks.", image: actDubaiSouk },
  ],
  Mauritius: [
    { title: "Île aux Cerfs Catamaran", desc: "Full-day island hop with snorkeling, BBQ lunch and waterfall stop.", image: actMuIle },
    { title: "Black River Gorges", desc: "Hike rainforests, viewpoints and the seven coloured earths of Chamarel.", image: actMuBlackRiver },
    { title: "Dolphin Swim at Tamarin", desc: "Early-morning boat trip to swim with wild spinner dolphins.", image: actMuDolphins },
    { title: "Le Morne Beach Day", desc: "UNESCO-listed peninsula, kite surfing, snorkeling & sunset cocktails.", image: actMuLeMorne },
  ],
  Zanzibar: [
    { title: "Stone Town Heritage Walk", desc: "Spice market, House of Wonders and Freddie Mercury's birthplace.", image: actZnStone },
    { title: "Nakupenda Sandbank", desc: "Boat trip to a pristine sandbar with fresh seafood lunch.", image: actZnNakupenda },
    { title: "Spice Farm Tour", desc: "Taste cloves, vanilla and nutmeg straight from the source.", image: actZnSpice },
    { title: "Mnemba Atoll Snorkel", desc: "Reef teeming with turtles, dolphins and tropical fish.", image: actZnMnemba },
  ],
  "Cape Town": [
    { title: "Table Mountain Cableway", desc: "Rotating cable car to the iconic flat-topped summit.", image: actCtTable },
    { title: "Cape Point & Boulders Beach", desc: "Peninsula drive with African penguins at Boulders.", image: actCtCapePoint },
    { title: "Stellenbosch Winelands", desc: "Tastings at boutique estates with Cape Dutch architecture.", image: actCtStellen },
    { title: "V&A Waterfront", desc: "Harbour dining, Two Oceans Aquarium and Robben Island ferry.", image: actCtVa },
  ],
  "SA Safari": [
    { title: "Big Five Game Drives", desc: "Dawn & dusk drives with expert rangers in private Kruger concessions.", image: actSfBigFive },
    { title: "Bush Walk Experience", desc: "Tracked walk with armed guide, focus on tracks, plants and birding.", image: actSfBushwalk },
    { title: "Boma Dinner Under the Stars", desc: "Open-fire feast with traditional music in the heart of the bush.", image: actSfBoma },
    { title: "Panorama Route", desc: "Blyde River Canyon, God's Window and Bourke's Luck Potholes.", image: actSfPanorama },
  ],
  "United Kingdom": [
    { title: "London Icons Tour", desc: "Big Ben, Westminster, Buckingham Palace and a Thames river cruise.", image: actUkLondon },
    { title: "Tower of London & Crown Jewels", desc: "Guided tour through 1,000 years of royal history.", image: actUkTower },
    { title: "Cotswolds Countryside Day", desc: "Honey-stone villages, pubs and English afternoon tea.", image: actUkCots },
    { title: "Edinburgh Add-on", desc: "Castle, Royal Mile and Highlands optional extension.", image: actUkEdin },
  ],
  Canada: [
    { title: "Banff & Lake Louise", desc: "Turquoise glacial lakes, gondolas and Rocky Mountain hikes.", image: actCaBanff },
    { title: "Niagara Falls Experience", desc: "Hornblower boat cruise into the mist of the falls.", image: actCaNiagara },
    { title: "Vancouver City & Capilano", desc: "Stanley Park, Granville Island and the suspension bridge.", image: actCaVan },
    { title: "Whale Watching Victoria", desc: "Orcas, humpbacks and bald eagles off Vancouver Island.", image: actCaWhales },
  ],
  "United States": [
    { title: "New York City Pass", desc: "Statue of Liberty, Empire State, Times Square and Broadway.", image: actUsNyc },
    { title: "Las Vegas & Grand Canyon", desc: "Strip nightlife plus a helicopter tour over the canyon.", image: actUsVegas },
    { title: "Orlando Theme Parks", desc: "Walt Disney World and Universal Studios family days.", image: actUsOrlando },
    { title: "California Coast Drive", desc: "LA to San Francisco along the Pacific Coast Highway.", image: actUsCali },
  ],
  Australia: [
    { title: "Sydney Harbour Cruise", desc: "Opera House, Harbour Bridge climb and Bondi Beach.", image: actAuSydney },
    { title: "Great Barrier Reef", desc: "Snorkel or dive the world's largest coral reef from Cairns.", image: actAuReef },
